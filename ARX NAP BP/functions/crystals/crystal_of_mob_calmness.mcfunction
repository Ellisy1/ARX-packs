...
# Если allow
execute if entity @s[tag=allow] run tellraw @s { "rawtext": [ { "text": "§aИспользован кристалл щита!" } ] }
...
# Если нет allow
execute if entity @s[tag=!allow] run tellraw @s { "rawtext": [ { "text": "§cЭффект ранее использованного кристалла щита всё ещё активен" } ] }
