...
# Недопуск
    tellraw @s[scores={battery_avail=0}] { "rawtext": [ { "text": "§cНа бумаге в кейсе явно что-то написано, но язык вам абсолюно незнаком." } ] }
    tellraw @s[scores={battery_avail=1}, tag=!descriptor_equipped] { "rawtext": [ { "text": "§cНа бумаге в кейсе явно что-то написано, но язык вам абсолюно незнаком." } ] }
