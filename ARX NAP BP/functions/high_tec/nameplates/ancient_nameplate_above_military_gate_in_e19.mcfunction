...
# Успех
    execute as @s[scores={sk_a_26=1}, tag=has_enough_charge, tag=descriptor_equipped] run tellraw @s { "rawtext": [ { "text": "§f[§bПереведено§f>>> §oИнженерный военный департамент. Посторонним вход сторого воспрещён!§r§f]" } ] }
