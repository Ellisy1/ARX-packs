...
# Действия при поднятой камере
    tellraw @s[rx=-89] { "rawtext": [{ "text": "§aЗадан пол персонажа - женщина!" } ] } 
    scoreboard players set @s[rx=-89] gender 2
...
# Действия в нормальной позиции
    ...
    tellraw @s[rxm=-89] { "rawtext": [{ "text": "§6-----\n§7§oПоднимите камеру вертикально вверх и используйте этот предмет ещё раз, чтобы подтвердить, что §l§aпол вашего персонажа - женщина." } ] } 
