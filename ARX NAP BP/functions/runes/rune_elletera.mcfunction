...
# Канал 1
    ...
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADEN=!2}] ADEN 0
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADEN=2}] ADEN 99
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADENГ=!2}] ADENГ 0
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADENГ=2}] ADENГ 3
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADENГГГ=!2}] ADENГГГ 0
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADENГГГ=2}] ADENГГГ 3
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADFNГ=!2}] ADFNГ 0
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADFNГ=2}] ADFNГ 3
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADFNГГГ=!2}] ADFNГГГ 0
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADFNГГГ=2}] ADFNГГГ 3
...
# Канал 2
    ...
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDEN=!2}] BDEN 0
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDEN=2}] BDEN 99
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDENГ=!2}] BDENГ 0
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDENГ=2}] BDENГ 3
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDENГГГ=!2}] BDENГГГ 0
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDENГГГ=2}] BDENГГГ 3
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDFNГ=!2}] BDFNГ 0
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDFNГ=2}] BDFNГ 3
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDFNГГГ=!2}] BDFNГГГ 0
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDFNГГГ=2}] BDFNГГГ 3
...
# Канал 3
    ...
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDEN=!2}] CDEN 0
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDEN=2}] CDEN 99
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDENГ=!2}] CDENГ 0
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDENГ=2}] CDENГ 3
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDENГГГ=!2}] CDENГГГ 0
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDENГГГ=2}] CDENГГГ 3
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDFNГ=!2}] CDFNГ 0
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDFNГ=2}] CDFNГ 3
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDFNГГГ=!2}] CDFNГГГ 0
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDFNГГГ=2}] CDFNГГГ 3
...
# Канал 4
    ...
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDEN=!2}] DDEN 0
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDEN=2}] DDEN 99
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDENГ=!2}] DDENГ 0
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDENГ=2}] DDENГ 3
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDENГГГ=!2}] DDENГГГ 0
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDENГГГ=2}] DDENГГГ 3
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDFNГ=!2}] DDFNГ 0
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDFNГ=2}] DDFNГ 3
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDFNГГГ=!2}] DDFNГГГ 0
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDFNГГГ=2}] DDFNГГГ 3
...
# Канал 5
    ...
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDEN=!2}] EDEN 0
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDEN=2}] EDEN 99
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDENГ=!2}] EDENГ 0
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDENГ=2}] EDENГ 3
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDENГГГ=!2}] EDENГГГ 0
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDENГГГ=2}] EDENГГГ 3
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDFNГ=!2}] EDFNГ 0
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDFNГ=2}] EDFNГ 3
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDFNГГГ=!2}] EDFNГГГ 0
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDFNГГГ=2}] EDFNГГГ 3
...
# Канал 6
    ...
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDEN=!2}] FDEN 0
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDEN=2}] FDEN 99
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDENГ=!2}] FDENГ 0
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDENГ=2}] FDENГ 3
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDENГГГ=!2}] FDENГГГ 0
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDENГГГ=2}] FDENГГГ 3
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDFNГ=!2}] FDFNГ 0
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDFNГ=2}] FDFNГ 3
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDFNГГГ=!2}] FDFNГГГ 0
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDFNГГГ=2}] FDFNГГГ 3
