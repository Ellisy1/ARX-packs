...
# Канал 1
    ...
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADIR=!2}] ADIR 0
    execute as @s[rx=-60] run scoreboard players set @s[scores={ADIR=2}] ADIR 99
...
# Канал 2
    ...
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDIR=!2}] BDIR 0
    execute as @s[rxm=-60, rx=-30] run scoreboard players set @s[scores={BDIR=2}] BDIR 99
...
# Канал 3
    ...
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDIR=!2}] CDIR 0
    execute as @s[rxm=-30, rx=0] run scoreboard players set @s[scores={CDIR=2}] CDIR 99
...
# Канал 4
    ...
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDIR=!2}] DDIR 0
    execute as @s[rxm=0.001, rx=30] run scoreboard players set @s[scores={DDIR=2}] DDIR 99
...
# Канал 5
    ...
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDIR=!2}] EDIR 0
    execute as @s[rxm=30, rx=60] run scoreboard players set @s[scores={EDIR=2}] EDIR 99
...
# Канал 6
    ...
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDIR=!2}] FDIR 0
    execute as @s[rxm=60] run scoreboard players set @s[scores={FDIR=2}] FDIR 99
