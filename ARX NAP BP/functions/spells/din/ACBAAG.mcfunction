...
#Заклинание
    ...
    execute as @s[tag=spell_available, scores={target=1}] run scoreboard players set @s[scores={allow_magilight=..180}] allow_magilight 180
    ...
    execute as @s[tag=spell_available, scores={target=2}] run scoreboard players set @p[tag=self2, scores={allow_magilight=..180}] allow_magilight 180
