#Анализ доступности
    scoreboard players set @s mp_req 180
...
#Заклинание
    ...
    execute as @s[tag=spell_available, scores={target=1}] run scoreboard players set @s[scores={allow_archlight=..900}] allow_archlight 900
    ...
    execute as @s[tag=spell_available, scores={target=2}] run scoreboard players set @p[tag=self2, scores={allow_archlight=..900}] allow_archlight 900
