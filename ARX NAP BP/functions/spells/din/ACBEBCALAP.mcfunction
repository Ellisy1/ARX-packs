...
#Заклинание
    execute as @s[tag=spell_available, scores={target=1, mark=1..}] run tellraw @s { "rawtext": [ { "text": "§aУ вас появляется небольшая грудь..." } ] }
    execute as @s[tag=spell_available, scores={target=1, mark=1..}] run event entity @s arx:property_bust_size_set_1
    ...
    execute as @s[tag=spell_available, scores={target=2}] as @p[tag=self2, scores={mark=1..}] run tellraw @s { "rawtext": [ { "text": "§aУ вас появляется небольшая грудь..." } ] }
    execute as @s[tag=spell_available, scores={target=2}] as @p[tag=self2, scores={mark=1..}] run event entity @s arx:property_bust_size_set_1
