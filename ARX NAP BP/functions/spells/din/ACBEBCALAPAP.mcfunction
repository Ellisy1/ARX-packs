...
#Заклинание
    execute as @s[tag=spell_available, scores={target=1, mark=1..}] run tellraw @s { "rawtext": [ { "text": "§aУ вас появляется средняя грудь..." } ] }
    execute as @s[tag=spell_available, scores={target=1, mark=1..}] run event entity @s arx:property_bust_size_set_2
    ...
    execute as @s[tag=spell_available, scores={target=2}] as @p[tag=self2, scores={mark=1..}] run tellraw @s { "rawtext": [ { "text": "§aУ вас появляется средняя грудь..." } ] }
    execute as @s[tag=spell_available, scores={target=2}] as @p[tag=self2, scores={mark=1..}] run event entity @s arx:property_bust_size_set_2
