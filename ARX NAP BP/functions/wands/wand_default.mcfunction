...
# Без особой религии
    playanimation @s[scores={religion=!5, religion=!15, religion=!25, sk_a_23=1}] animation.arx.wand_b_a
...
# С религией - вышкой
    ...
    playanimation @s[scores={custom_random=..333, religion=25, sk_a_23=1}] animation.arx.wand_a_a
    playanimation @s[scores={custom_random=334..666, religion=25, sk_a_23=1}] animation.arx.wand_a_b
    playanimation @s[scores={custom_random=667.., religion=25, sk_a_23=1}] animation.arx.wand_a_c
