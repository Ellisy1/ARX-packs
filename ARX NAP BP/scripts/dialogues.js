    ...
    gasgolder_in_bar_ch1: {
        start: {
            ...
            buttons: [
                ...
                { text: "Ты знаешь про культ?", next: "about_cult" }
            ]
        },
        about_bar: {
            id: "about_bar",
            title: "О баре",
            body: "Это наше место. Здесь довольно безопасно, но я не советую ходить на нижние этажи. Там иногда лезет всякая дрянь.",
            buttons: [
                { text: "Почему тут закрытая лавка?", next: "about_provolochka_shop" },
                { text: "Назад", next: "start" }
            ]
        },
        about_provolochka_shop: {
            id: "about_provolochka_shop",
            title: "О лавке",
            body: "Здесь была Проволочка (выглядит грустно). Она была милая, знаешь. Делала мне скидки. Пилу я именно у неё купил. Она вечно исследовала всё и таскала всякие древности сюда, продавая их в основном нашему учёному, Цугундеру. Недавно она просто не вернулась. Я не знаю, почему. Если вы ее найдете, я вам пилу свою отдам!",
            buttons: [
        ...
        about_trade: {
            id: "about_trade",
            title: "О торговле",
            body: "(Кашляет) Я сейчас не торгую. Пересчитываю монеты. Найди меня, когда я буду странствовать, и тогда поторгуем.",
            buttons: [
                { text: "В начало", next: "start" }
            ]
        },
        about_cult: {
            id: "about_cult",
            title: "О торговле",
            body: "Ахаха, идиотский вопрос! Кто не знает. Эти придурки в красном, покланяющиеся Раттексу. Эти сволочи, представьте, В БАРЕ напали на Фринцера, когда тот что-то про Раттекса ляпнул. До того момента я не знал, что его пушка ТАК ГРОМКО стреляет. (Громко смеётся) Жаль что ты пропустил это.",
            buttons: [
                { text: "В начало", next: "start" }
            ]
        }
