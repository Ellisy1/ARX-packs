...
function getBodyText(player) {
...

    {
        switch (getScore(player, "stress_cond")) {
            case 4:
                bodyText += 'đ Стресс 4 (макс.) уровня.\n§e|§f Характеристики §4сильно понижены§f'
                break
            case 3:
                bodyText += 'đ Стресс 3 уровня.\n§e|§f Характеристики §cпонижены§f'
                break
            case 2:
                bodyText += 'đ Стресс 2 уровня.\n§e|§f Характеристики §eнемного понижены§f'
                break
            case 1:
                bodyText += 'đ Стресс 1 уровня.\n§e|§f Характеристики не изменены'
                break
            case 0:
                bodyText += 'ē Нейтральное настроение.\n§e|§f Характеристики не изменены'
                break
            case -1:
                bodyText += 'Ē Счастье 1 уровня.\n§e|§f Характеристики не изменены'
                break
            case -2:
                bodyText += 'Ē Счастье 2 уровня.\n§e|§f Характеристики §aнемного повышены§f'
                break
            case -3:
                bodyText += 'Ē Счастье 3 уровня.\n§e|§f Характеристики §aповышены§f'
                break
            case -4:
                bodyText += 'Ē Счастье 4 (макс.) уровня.\n§e|§f Характеристики §aсильно повышены§f'
                break
            default:
