...
# СТРЕСС
    ...
    #Матершинник
        #Мат на нематерящихся
            execute @a[scores={c_rude=1.., custom_random=410..430}] ~ ~ ~ scoreboard players add @a[scores={c_rude=0}, rm=0.5, r=10] stress 150
            execute @a[scores={c_rude=1.., custom_random=410..430}] ~ ~ ~ w @a[scores={c_rude=0}, rm=0.5, r=10] @p[scores={c_rude=1..}] много матерится. Мне это неприятно.
        #Мат на матершинника
            execute @a[scores={c_rude=1.., custom_random=410..430}] ~ ~ ~ scoreboard players add @a[scores={c_rude=1}, rm=0.5, r=10] stress -100
            execute @a[scores={c_rude=1.., custom_random=410..430}] ~ ~ ~ w @a[scores={c_rude=1}, rm=0.5, r=10] @p[scores={c_rude=1..}] много матерится. Как же это охуенно!
    ...
    #Воздействие черт
        execute @e[type=spider] ~ ~ ~ scoreboard players add @a[r=5, scores={c_nospider=1..}] stress 100
        execute @e[type=spider] ~ ~ ~ title @a[r=5, scores={c_nospider=1..}] actionbar Вы боитесь паука!

        execute @e[type=zombie] ~ ~ ~ scoreboard players add @a[r=5, scores={c_nonecro=1..}] stress 100
        execute @e[type=zombie] ~ ~ ~ title @a[r=5, scores={c_nonecro=1..}] actionbar Вы боитесь мертвеца!

        execute @e[type=skeleton] ~ ~ ~ scoreboard players add @a[r=5, scores={c_nonecro=1..}] stress 100
        execute @e[type=skeleton] ~ ~ ~ title @a[r=5, scores={c_nonecro=1..}] actionbar Вы боитесь скелета!

        execute @a[scores={class=1}] ~ ~ ~ scoreboard players add @a[r=5, rm=0.5, scores={c_nonecro=1..}] stress 100
        execute @a[scores={class=1}] ~ ~ ~ title @a[r=5, rm=0.0001, scores={c_nonecro=1..}] actionbar Вы боитесь призрака!

        execute @a ~ ~ ~ scoreboard players add @a[r=8, rm=0.5, scores={c_nosocio=1..}] stress 6
        execute @a ~ ~ ~ title @a[r=8, rm=0.5, scores={c_nosocio=1..}] actionbar Вам неприятно в обществе

        scoreboard players add @a[scores={c_nodarkness=1..}, tag=low_bright] stress 3
        execute @a[scores={c_nodarkness=1..}, tag=low_bright] ~ ~ ~ title @s actionbar Вы боитесь темноты!

        execute @a[scores={c_nolight=1..}, tag=high_bright] ~ ~ ~ scoreboard players add @s stress 3
        execute @a[scores={c_nolight=1..}, tag=high_bright] ~ ~ ~ title @s actionbar Вы боитесь света!
    ...
    #Рассчёт дельты
        execute @a ~ ~ ~ scoreboard players operation @s stress_co_delta = @s stress_cond
        execute @a ~ ~ ~ scoreboard players operation @s stress_co_delta -= @s stress_co_hist
        execute @a ~ ~ ~ scoreboard players operation @s stress_co_hist = @s stress_cond
    ...
    #Получение-снятие черт характера 
        execute @a[scores={stress_cond=4, custom_random=700, custom_random_b=0..500}] ~ ~ ~ function traits/get_negative_trait
        execute @a[scores={stress_cond=4, custom_random=700, custom_random_b=501..833}] ~ ~ ~ function traits/get_neutral_trait
        execute @a[scores={stress_cond=4, custom_random=700, custom_random_b=834..1000}] ~ ~ ~ function traits/get_positive_trait

        execute @a[scores={c_unstable=1.., stress_cond=4, custom_random=701, custom_random_b=0..500}] ~ ~ ~ function traits/get_negative_trait
        execute @a[scores={c_unstable=1.., stress_cond=4, custom_random=701, custom_random_b=501..833}] ~ ~ ~ function traits/get_neutral_trait
        execute @a[scores={c_unstable=1.., stress_cond=4, custom_random=701, custom_random_b=834..1000}] ~ ~ ~ function traits/get_positive_trait
        ...
        execute @a[scores={stress_cond=-4}] ~ ~ ~ function traits/clear_loose_traits
