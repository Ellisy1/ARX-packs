...
#Дроп
give @p[tag=self, scores={sk_a_11=1}] arx:camel_meat 3
give @p[tag=self, scores={sk_a_14=1}] arx:camel_skin 1
give @p[tag=self, scores={sk_a_15=1}] arx:hoof 4
give @p[tag=self, scores={sk_a_16=1}] bone 5
