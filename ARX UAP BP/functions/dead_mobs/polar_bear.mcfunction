...
#Дроп
give @p[tag=self, scores={sk_a_11=1}] arx:polar_bear_meat 2
give @p[tag=self, scores={sk_a_14=1}] arx:polar_bear_skin 1
give @p[tag=self, scores={sk_a_16=1}] bone 6
give @p[tag=self, scores={sk_a_19=1}] arx:grease 3
...
#Удаляем предмет
clear @p arx:dead_polar_bear 0 1
