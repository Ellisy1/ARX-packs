...
#Дроп
give @p[tag=self, scores={sk_a_11=1}] arx:rat_monstr_meat 1
give @p[tag=self, scores={sk_a_14=1}] arx:rat_monstr_skin 1
give @p[tag=self, scores={sk_a_16=1}] bone 2
give @p[tag=self, scores={sk_a_17=1}] arx:fang 2
give @p[tag=self, scores={sk_a_18=1}] arx:claws 2
give @p[tag=self, scores={sk_b_6=1}] arx:beast_heart 1
give @p[tag=self, scores={sk_b_7=1}] arx:brain 1
give @p[tag=self, scores={sk_b_8=1}] arx:liver 1
give @p[tag=self, scores={sk_b_9=1}] arx:monster_eye 2
...
#Если нет навыков
tellraw @p[tag=self, scores={gender=1, sk_a_11=0, sk_a_14=0, sk_a_16=0, sk_a_17=0, sk_a_18=0, sk_b_6=0, sk_b_7=0, sk_b_8=0, sk_b_9=0, sk_c_6=0}] { "rawtext": [ { "text": "§6Я ничего не смог достать..." } ] }
tellraw @p[tag=self, scores={gender=2, sk_a_11=0, sk_a_14=0, sk_a_16=0, sk_a_17=0, sk_a_18=0, sk_b_6=0, sk_b_7=0, sk_b_8=0, sk_b_9=0, sk_c_6=0}] { "rawtext": [ { "text": "§6Я ничего не смогла достать..." } ] }

#Дропаем ОП
scoreboard players add @p xp_tray 10

#Удаляем предмет
clear @p arx:dead_rat_monstr 0 1
