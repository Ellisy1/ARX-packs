...
#Заклинание
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ effect @a[r=15, scores={blind_block=0}] darkness 20 0 true
    
    execute @p[tag=self, tag=spell_available, scores={target=2}] ~ ~ ~ effect @a[r=15, tag=!self, scores={blind_block=0}] darkness 20 0 true
