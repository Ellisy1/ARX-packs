...
#Заклинание
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ tp @p @p[r=15, scores={mark=1..}]

    execute @p[tag=self, tag=spell_available, scores={target=2}] ~ ~ ~ tp @p[r=15, scores={mark=1..}] @p
