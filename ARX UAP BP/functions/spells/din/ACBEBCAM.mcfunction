...
#Заклинание
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ effect @p resistance 60 255 true
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ effect @p invisibility 60 255 true
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ effect @p slowness 60 255 true
