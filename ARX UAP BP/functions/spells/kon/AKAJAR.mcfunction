...
#Заклинание
    ...
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ effect @p regeneration 20 0
    ...
    execute @p[tag=self, tag=spell_available, scores={target=2}] ~ ~ ~ execute @p[tag=self2] ~ ~ ~ effect @p[tag=self] regeneration 20 0
    ...
    execute @p[tag=self, tag=spell_available, scores={target=3}] ~ ~ ~ execute @e[type=!player, type=!item, r=15] ~ ~ ~ effect @p[tag=self] regeneration 20 0
    execute @p[tag=self, tag=spell_available, scores={target=3}] ~ ~ ~ execute @e[type=!player, type=!item, r=15] ~ ~ ~ damage @e[r=0.0001, scores={tick_nosempra_a=0, tick_nosempra_b=0, tick_nosempra_c=0}] 3 suicide
    execute @p[tag=self, tag=spell_available, scores={target=3}] ~ ~ ~ execute @e[type=!player, type=!item, r=15] ~ ~ ~ damage @e[r=0.0001, scores={tick_nosempra_a=!0}] 2 suicide
