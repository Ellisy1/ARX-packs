...
#Заклинание
    ...
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ damage @p[tag=self, scores={tick_nosempra_a=0, tick_nosempra_b=0, tick_nosempra_c=0}] 20 entity_attack entity @p
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ damage @p[tag=self, scores={tick_nosempra_a=!0}] 15 entity_attack entity @p
    execute @p[tag=self, tag=spell_available, scores={target=1}] ~ ~ ~ damage @p[tag=self, scores={tick_nosempra_b=!0}] 10 entity_attack entity @p
    ...
    execute @p[tag=self, tag=spell_available, scores={target=2}] ~ ~ ~ damage @p[tag=self2, scores={tick_nosempra_a=0, tick_nosempra_b=0, tick_nosempra_c=0}] 20 entity_attack entity @p
    execute @p[tag=self, tag=spell_available, scores={target=2}] ~ ~ ~ damage @p[tag=self2, scores={tick_nosempra_a=!0}] 15 entity_attack entity @p
    execute @p[tag=self, tag=spell_available, scores={target=2}] ~ ~ ~ damage @p[tag=self2, scores={tick_nosempra_b=!0}] 10 entity_attack entity @p
